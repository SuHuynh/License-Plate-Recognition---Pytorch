...
from data.load_data_2 import CHARS, CHARS_DICT, LPRDataLoader
...
def get_parser():
    ...
    # parser.add_argument('--train_img_dirs', default="./data_new/anpr_ocr-1790/train/anpr_ocr/train/img", help='the train images path')
    # parser.add_argument('--test_img_dirs', default="./data_new/anpr_ocr-1790/val/anpr_ocr/train/img", help='the test images path')

    parser.add_argument('--train_img_dirs', default='./train_data.csv', help='the train images path')
    parser.add_argument('--test_img_dirs', default="./test_data.csv", help='the test images path')
...
def train():
    ...
    test_dataset = LPRDataLoader(args.test_img_dirs.split(','), args.img_size, args.lpr_max_len)
    ...
    torch.save(lprnet.state_dict(), args.save_folder + 'Su_LPRNet_model_CarsReId.pth')
